...
- 🔭 Working on infrastructure surveying for the **New Tana River Bridge Project** (Rhines Engineering Services Ltd / Batch Consulting Engineers JV)
...
`RTK GNSS` `Total Station (±10mm)` `UAV Mapping`

**Software**
`ArcGIS Pro` `QGIS` `AutoCAD Civil 3D` `Pix4D` `DroneDeploy`
...
*Built for precision on the ground, and increasingly, in the air.*
